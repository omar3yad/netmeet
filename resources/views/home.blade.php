...
@section('content')
    <section class="page-section theme-bg">
        ...
        <div class="floating-shapes">
            <div class="shape"><i class="fa fa-video fa-2x"></i></div>
            <div class="shape"><i class="fa fa-phone fa-2x"></i></div>
            <div class="shape"><i class="fa fa-camera fa-2x"></i></div>
            <div class="shape"><i class="fa fa-comments fa-2x"></i></div>
            <div class="shape"><i class="fa fa-users fa-2x"></i></div>
            <div class="shape"><i class="fa fa-share-alt fa-2x"></i></div>
        </div>
     ...
     <section class="page-section  about-desc">
                        ...
                        <form id="meeting">
                            <div class="input-group mb-2">
                                <input type="text" name="id" class="form-control conference-id" id="conferenceId"
                                    ...
                                    autocomplete="on" maxlength="11" pattern="^[0-9-]+$"
    ...
    @if (getSetting('LANDING_PAGE') == 'enabled')
            ...
            <div class="container pb-5 about-data">
                <div class="row align-items-center pb-5 mt-5">
                    <div class="col-12 col-lg-6">
                        <h1 class="main-title w-100 text-left " style="padding-top: 1rem;">{{ __('About The Site') }}</h1>
                    ...
                    <div class="col-12 col-lg-6 text-center">
                            <img src="{{ asset('images/sideIMG.png') }}" alt="Side Image" class="img-fluid">
                    </div>
                </div>
            </div>
        </section>
        ...
        <section class="about-section feature-section page-section">
            <div class="container pt-3">
                <div class="row w-100">
                    <h1 class="main-title  w-100 text-center" style="padding-top: 1rem;">{{ __('Video Conference Features') }}</h1>
                </div>
        ...
        <!-- Chat section :: start -->
        <section class="page-section theme-bg " style="padding-bottom: 2rem;">
            <div class="container text-white">
                <div class="row w-100">
                    <h1 class="main-title w-100 text-center" style="color: white;">{{ __('How To Host Video Meetings') }}</h1>
                </div>
        ...
        <section style="padding: 80px 0; background-color: #f8f9fa;">
            ...
            <div class="row align-items-center">
                ...
                <h1 style="font-size: 2.5rem; margin-bottom: 1rem; width: 100%; text-align: center;">{{ __('5-Star Rated Application') }}</h1>
                <p style="font-size: 1.1rem; line-height: 1.6; color: #666;">{{ __('The application is the best way to host video meetings online. The easy-to-use features make it more convenient to use this application for users. Try hosting a meeting now, you will get to know how easy to use the features are') }}</p>
                </div>
            </div>
            </div>
        </section>
        ...
        <section class="page-section theme-bg" style="  padding-bottom: 6rem;">
            <div class="container">
                <div class="row">
                    <h1 class="main-title text-white w-100 text-center">
                        {{ __('What are you waiting for?') }}<br>{{ __('Start a meeting now') }}
                    </h1>
                    <a class="start-btn" style="color: white;">{{ __('Start Now') }}</a>
                </div>
            </div>
        </section>
        <!-- start chat section :: end -->
    @endif
    {{-- Floating Download Button removed (replaced by PWA install) --}}
@endsection
...
@section('script')
    ...
    document.getElementById('floatingDownloadBtn').addEventListener('click', function(e) {
        e.preventDefault();

        // Use the existing PWA install modal logic from main.js
        if (typeof showInstallModal === "function") {
            ...
            console.error("showInstallModal() not found. Make sure main.js is loaded.");
        }
    });

         document.getElementById('conferenceId').addEventListener('input', function(e) {
